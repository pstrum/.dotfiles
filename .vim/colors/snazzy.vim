" Vim Color File
" Name:       snazzy.vim
" Maintainer: https://github.com/pstrum/snazzy.vim/
...
" | Black        | rgb(          )    | #282a36 |
" |--------------+--------------------+---------|
" | White        | rgb(171, 178, 191) | #eff0eb |
" |--------------+--------------------+---------|
" | Light Red    | rgb(224, 108, 117) | #ff5c57 |
" |--------------+--------------------+---------|
" | Dark Red     | rgb(190, 80, 70)   | #ff5c57 |
" |--------------+--------------------+---------|
" | Green        | rgb(152, 195, 121) | #5af78e |
" |--------------+--------------------+---------|
" | Light Yellow | rgb(229, 192, 123) | #f3f99d |
" |--------------+--------------------+---------|
" | Dark Yellow  | rgb(209, 154, 102) | #f3f99d |
" |--------------+--------------------+---------|
" | Blue         | rgb(97, 175, 239)  | #57c7ff |
" |--------------+--------------------+---------|
" | Magenta      | rgb(198, 120, 221) | #ff6ac1 |
" |--------------+--------------------+---------|
" | Cyan         | rgb(86, 182, 194)  | #9aedfe |
" |--------------+--------------------+---------|
...
call s:h("Directory", { "fg": s:white }) " directory names (and other special names in listings)
